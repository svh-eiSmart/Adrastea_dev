...
DRV_IF_CFG_Status DRV_IF_CFG_GetDefConfig(Interface_Id intf, void *config) {
  ...
  switch (intf) {
...
#if IF_CFG_UART_IS_DEFINED(UARTF1)
    case IF_CFG_UARTF1:
      serial_config = (DRV_UART_Config *)config;
      serial_config->BaudRate = UARTF1_BAUDRATE_DEFAULT;
      serial_config->WordLength = UARTF1_WORDLENGTH_DEFAULT;
      serial_config->StopBits = UARTF1_STOPBITS_DEFAULT;
      serial_config->Parity = UARTF1_PARITY_DEFAULT;
      serial_config->HwFlowCtl = UARTF1_HWFLOWCTRL_DEFAULT;
      ret = DRV_IF_CFG_OK;
      break;
#endif
    ...
    case IF_CFG_SPIM0:
      ...
      break;
#endif
#if IF_CFG_SPIM_IS_DEFINED(SPIM1)
    case IF_CFG_SPIM1:
      spi_config = (SPI_Config *)config;
      spi_config->bus_id = SPI_BUS_1;
      ...
      spi_config->param.bit_order = SPIM1_BITORDER_DEFAULT;
      spi_config->param.bus_speed = SPIM1_BUSSPEED_DEFAULT;
      spi_config->param.data_bits = SPIM1_DATABITS_DEFAULT;
      spi_config->param.ss_mode = SPIM1_SSMODE_DEFAULT;
      ret = DRV_IF_CFG_OK;
      break;
#endif
    ...
    case IF_CFG_I2C0:
      break;
#endif
#if IF_CFG_I2C_IS_DEFINED(I2C1)
    case IF_CFG_I2C1:
      break;
#endif
#if IF_CFG_PWM_IS_DEFINED(PWM0)
    case IF_CFG_PWM0:
      pwm_config = (PWM_DAC_Param *)config;
      pwm_config->clk_div = PWM0_CLK_DIV_DEFAULT;
      pwm_config->duty_cycle = PWM0_DUTY_CYCLE_DEFAULT;
      ret = DRV_IF_CFG_OK;
      break;
#endif
    ...
    case IF_CFG_PWM1:
      pwm_config = (PWM_DAC_Param *)config;
      pwm_config->clk_div = PWM1_CLK_DIV_DEFAULT;
      pwm_config->duty_cycle = PWM1_DUTY_CYCLE_DEFAULT;
      ret = DRV_IF_CFG_OK;
      break;
#endif
#if IF_CFG_PWM_IS_DEFINED(PWM2)
    case IF_CFG_PWM2:
      pwm_config = (PWM_DAC_Param *)config;
      pwm_config->clk_div = PWM2_CLK_DIV_DEFAULT;
      pwm_config->duty_cycle = PWM2_DUTY_CYCLE_DEFAULT;
      ret = DRV_IF_CFG_OK;
      break;
#endif
#if IF_CFG_PWM_IS_DEFINED(PWM3)
    case IF_CFG_PWM3:
      pwm_config = (PWM_DAC_Param *)config;
      pwm_config->clk_div = PWM3_CLK_DIV_DEFAULT;
      pwm_config->duty_cycle = PWM3_DUTY_CYCLE_DEFAULT;
      ret = DRV_IF_CFG_OK;
      break;
#endif
...
#if IF_CFG_UART_IS_DEFINED(UARTF1)
    case IF_CFG_UARTF1:
      if ((io_ret = DRV_IO_SetMux(UARTF1_RX_PIN_SET,
                                  PIN_MUX_VALUE(UARTF1_RX_PIN_SET, UART1_RXD))) != DRV_IO_OK)
        goto out;
      if ((io_ret = DRV_IO_SetMux(UARTF1_TX_PIN_SET,
                                  PIN_MUX_VALUE(UARTF1_TX_PIN_SET, UART1_TXD))) != DRV_IO_OK)
        goto out;
      if ((io_ret = DRV_IO_SetPull(UARTF1_RX_PIN_SET, IO_PULL_DOWN)) != DRV_IO_OK) goto out;
#if IF_CFG_UART_RTS_CTS_IS_DEFINED(UARTF1)
      if ((io_ret = DRV_IO_SetMux(UARTF1_RTS_PIN_SET,
                                  PIN_MUX_VALUE(UARTF1_RTS_PIN_SET, UART1_RTS_N))) != DRV_IO_OK)
        goto out;
      if ((io_ret = DRV_IO_SetMux(UARTF1_CTS_PIN_SET,
                                  PIN_MUX_VALUE(UARTF1_CTS_PIN_SET, UART1_CTS_N))) != DRV_IO_OK)
        goto out;
#endif
      ret = DRV_IF_CFG_OK;
      break;
...
#if IF_CFG_SPIM_IS_DEFINED(SPIM1)
    case IF_CFG_SPIM1:
      if ((io_ret = DRV_IO_SetMux(SPIM1_CLK_PIN_SET,
                                  PIN_MUX_VALUE(SPIM1_CLK_PIN_SET, SPI1_SCK_OUT))) != DRV_IO_OK)
        goto out;
#if (SPIM1_EN_PIN_SET != ALT1250_PIN_UNDEFINED)
      if ((io_ret = DRV_IO_SetMux(SPIM1_EN_PIN_SET,
                                  PIN_MUX_VALUE(SPIM1_EN_PIN_SET, SPI1_CS0_OUT))) != DRV_IO_OK)
        goto out;
#endif
      if ((io_ret = DRV_IO_SetMux(SPIM1_MISO_PIN_SET,
                                  PIN_MUX_VALUE(SPIM1_MISO_PIN_SET, SPI1_CD_OUT))) != DRV_IO_OK)
        goto out;
      if ((io_ret = DRV_IO_SetMux(SPIM1_MOSI_PIN_SET,
                                  PIN_MUX_VALUE(SPIM1_MOSI_PIN_SET, SPI1_MOSI_OUT))) != DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
#endif
...
#if IF_CFG_I2C_IS_DEFINED(I2C0)
    case IF_CFG_I2C0:
      if ((io_ret = DRV_IO_SetMux(I2C0_SDA_PIN_SET, PIN_MUX_VALUE(I2C0_SDA_PIN_SET, I2C0_SDA_OUT))) !=
          DRV_IO_OK)
        goto out;
      if ((io_ret = DRV_IO_SetMux(I2C0_SCL_PIN_SET, PIN_MUX_VALUE(I2C0_SCL_PIN_SET, I2C0_SCL_OUT))) !=
          DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
...
#if IF_CFG_I2C_IS_DEFINED(I2C1)
    case IF_CFG_I2C1:
      if ((io_ret = DRV_IO_SetMux(I2C1_SDA_PIN_SET, PIN_MUX_VALUE(I2C1_SDA_PIN_SET, I2C1_SDA_OUT))) !=
          DRV_IO_OK)
        goto out;
      if ((io_ret = DRV_IO_SetMux(I2C1_SCL_PIN_SET, PIN_MUX_VALUE(I2C1_SCL_PIN_SET, I2C1_SCL_OUT))) !=
          DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
...
#if IF_CFG_GPIO_IS_DEFINED(01)
    case IF_CFG_GPIO01:
      if ((io_ret = DRV_IO_SetMux(GPIO_ID_01_PIN_SET, PIN_MUX_VALUE(GPIO_ID_01_PIN_SET, GPIO))) != DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
#endif
...
#if IF_CFG_GPIO_IS_DEFINED(02)
    case IF_CFG_GPIO02:
      if ((io_ret = DRV_IO_SetMux(GPIO_ID_02_PIN_SET, PIN_MUX_VALUE(GPIO_ID_02_PIN_SET, GPIO))) != DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
#endif
...
#if IF_CFG_GPIO_IS_DEFINED(03)
    case IF_CFG_GPIO03:
      if ((io_ret = DRV_IO_SetMux(GPIO_ID_03_PIN_SET, PIN_MUX_VALUE(GPIO_ID_03_PIN_SET, GPIO))) != DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
#endif
...
#if IF_CFG_GPIO_IS_DEFINED(04)
    case IF_CFG_GPIO04:
      if ((io_ret = DRV_IO_SetMux(GPIO_ID_04_PIN_SET, PIN_MUX_VALUE(GPIO_ID_04_PIN_SET, GPIO))) != DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
#endif
...
#if IF_CFG_GPIO_IS_DEFINED(05)
    case IF_CFG_GPIO05:
      if ((io_ret = DRV_IO_SetMux(GPIO_ID_05_PIN_SET, PIN_MUX_VALUE(GPIO_ID_05_PIN_SET, GPIO))) != DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
#endif
...
#if IF_CFG_GPIO_IS_DEFINED(06)
    case IF_CFG_GPIO06:
      if ((io_ret = DRV_IO_SetMux(GPIO_ID_06_PIN_SET, PIN_MUX_VALUE(GPIO_ID_06_PIN_SET, GPIO))) != DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
#endif
...
#if IF_CFG_GPIO_IS_DEFINED(07)
    case IF_CFG_GPIO07:
      if ((io_ret = DRV_IO_SetMux(GPIO_ID_07_PIN_SET, PIN_MUX_VALUE(GPIO_ID_07_PIN_SET, GPIO))) != DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
#endif
...
#if IF_CFG_GPIO_IS_DEFINED(08)
    case IF_CFG_GPIO08:
      if ((io_ret = DRV_IO_SetMux(GPIO_ID_08_PIN_SET, PIN_MUX_VALUE(GPIO_ID_08_PIN_SET, GPIO))) != DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
#endif
...
#if IF_CFG_GPIO_IS_DEFINED(09)
    case IF_CFG_GPIO09:
      if ((io_ret = DRV_IO_SetMux(GPIO_ID_09_PIN_SET, PIN_MUX_VALUE(GPIO_ID_09_PIN_SET, GPIO))) != DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
#endif
...
#if IF_CFG_GPIO_IS_DEFINED(10)
    case IF_CFG_GPIO10:
      if ((io_ret = DRV_IO_SetMux(GPIO_ID_10_PIN_SET, PIN_MUX_VALUE(GPIO_ID_10_PIN_SET, GPIO))) != DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
#endif
...
#if IF_CFG_LED_IS_DEFINED(LED3)
    case IF_CFG_LED3:
      if ((io_ret = DRV_IO_SetMux(LED3_PIN_SET, PIN_MUX_VALUE(LED3_PIN_SET, LED_CTRL_LED_3))) !=
          DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
...
#if IF_CFG_LED_IS_DEFINED(LED4)
    case IF_CFG_LED4:
      if ((io_ret = DRV_IO_SetMux(LED4_PIN_SET, PIN_MUX_VALUE(LED4_PIN_SET, LED_CTRL_LED_4))) !=
          DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
...
#if IF_CFG_LED_IS_DEFINED(LED5)
    case IF_CFG_LED5:
      if ((io_ret = DRV_IO_SetMux(LED5_PIN_SET, PIN_MUX_VALUE(LED5_PIN_SET, LED_CTRL_LED_5))) !=
          DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
...
#if IF_CFG_PWM_IS_DEFINED(PWM2)
    case IF_CFG_PWM2:
      if ((io_ret = DRV_IO_SetMux(PWM2_PIN_SET, PIN_MUX_VALUE(PWM2_PIN_SET, PWM2))) != DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
#endif
...
#if IF_CFG_PWM_IS_DEFINED(PWM3)
    case IF_CFG_PWM3:
      if ((io_ret = DRV_IO_SetMux(PWM3_PIN_SET, PIN_MUX_VALUE(PWM3_PIN_SET, PWM3))) != DRV_IO_OK)
        goto out;
      ret = DRV_IF_CFG_OK;
      break;
#endif
