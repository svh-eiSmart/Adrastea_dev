...
#define MCU_PROJECT_NAME "Emux_AtcmdConnector"

DECLARE_COMMAND("atb", do_atb, "atb <1|2> - Open AT bridge")
DECLARE_COMMAND("apitest", do_apitest, "apitest - Command for AtcmdConnector APIs test")
DECLARE_COMMAND("atcmd", do_atcmd, "atcmd - enter into AT MODE to send atcmd to apitest queue")
