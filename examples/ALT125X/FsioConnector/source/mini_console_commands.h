...
#define MCU_PROJECT_NAME "FsioConnector"

DECLARE_COMMAND("apitest", do_apitest, "apitest - Command for FsioConnector APIs test")
DECLARE_COMMAND("paste", do_paste, "paste - enter into text pasting mode to send to apitest queue")
