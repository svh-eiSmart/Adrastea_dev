 ...
 *  ------------------------------------------------------------------------
 * typedef enum {
 *      DRV_UART_BAUD_110 = 110U,
 *      DRV_UART_BAUD_1200 = 1200U,
 *      DRV_UART_BAUD_2400 = 2400U,
 *      DRV_UART_BAUD_9600 = 9600U,
 *      DRV_UART_BAUD_14400 = 14400U,
 *      DRV_UART_BAUD_19200 = 19200U,
 *      DRV_UART_BAUD_38400 = 38400U,
 *      DRV_UART_BAUD_57600 = 57600U,
 *      DRV_UART_BAUD_76800 = 76800U,
 *      DRV_UART_BAUD_115200 = 115200U,
 *      DRV_UART_BAUD_230400 = 230400U,
 *      DRV_UART_BAUD_460800 = 460800U,
 *      DRV_UART_BAUD_921600 = 921600U,
 *      DRV_UART_BAUD_1843200 = 1843200U,
 *      DRV_UART_BAUD_3686400 = 3686400U,
 * } DRV_UART_Baudrate;
 *  ------------------------------------------------------------------------
 *  HWFLOWCTL definitions:
 *  ------------------------------------------------------------------------
 *  typedef enum {
 *    DRV_UART_WORD_LENGTH_5B = 0U,
 *    DRV_UART_WORD_LENGTH_6B = 1U,
 *    DRV_UART_WORD_LENGTH_7B = 2U,
 *    DRV_UART_WORD_LENGTH_8B = 3U,
 ...
 *
 *   typedef enum {
 *     DRV_UART_PARITY_MODE_ZERO = 0U,
 *     DRV_UART_PARITY_MODE_ONE = 1U,
 *     DRV_UART_PARITY_MODE_ODD = 2U,
 *     DRV_UART_PARITY_MODE_EVEN = 3U,
 *     DRV_UART_PARITY_MODE_DISABLE = 4U,
 *   } DRV_UART_Parity;
 *  ------------------------------------------------------------------------
 *  STOPBITS definitions
 *  ------------------------------------------------------------------------
 *   typedef enum {
 *     DRV_UART_STOP_BITS_1 = 0U,
 *     DRV_UART_STOP_BITS_2 = 1U,
 *   } DRV_UART_Stop_Bits;
 *  ------------------------------------------------------------------------
...
/* Pins configuration */
#define GPIO_ID_01_PIN_SET	ALT1250_PIN_UNDEFINED

/* Interface configuration */
#define GPIO_ID_01_DIR_DEFAULT	ALT1250_CONFIG_UNDEFINED
#define GPIO_ID_01_PU_DEFAULT	ALT1250_CONFIG_UNDEFINED
#define GPIO_ID_01_VAL_DEFAULT	ALT1250_CONFIG_UNDEFINED
