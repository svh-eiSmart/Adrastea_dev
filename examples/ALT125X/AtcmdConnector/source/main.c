...
/* External buffpool interface includes */
...
static void altcom_init_task(void *arg) {
  ...
  mem_if_t memif = {memif_impl_create, memif_impl_destroy, memif_impl_alloc, memif_impl_free,
                    memif_impl_show};

  initCfg.bufMgmtCfg.mem_if = &memif;
