...
#define MCU_PROJECT_NAME "Lwm2mConnector"

DECLARE_COMMAND("apitest", do_apitest, "apitest - Command for Lwm2mConnector APIs test")
DECLARE_COMMAND("slog", do_slog, "slog - slog Usage [OPTIONS] Options:")
