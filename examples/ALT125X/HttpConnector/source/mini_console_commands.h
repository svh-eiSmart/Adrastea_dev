...
#define MCU_PROJECT_NAME "HTTPConnector"

DECLARE_COMMAND("apitest", do_apitest, "apitest - Command for HttpConnector APIs test")
...
DECLARE_COMMAND("Http_demo", do_Http_demo, "Http_demo <-p|X> <[0-4]|X> - HTTP demo")
