...
/* Pins configuration */
#define PWM0_PIN_SET	               ALT1250_GPIO60

/* Interface configuration */
#define PWM0_CLK_DIV_DEFAULT           (1)
#define PWM0_DUTY_CYCLE_DEFAULT        (512)

/* PWM-1 */
/*********/

/* Pins configuration */
#define PWM1_PIN_SET	               ALT1250_GPIO51

/* Interface configuration */
#define PWM1_CLK_DIV_DEFAULT           (1)
#define PWM1_DUTY_CYCLE_DEFAULT        (512)

/* PWM-2 */
/*********/

/* Pins configuration */
#define PWM2_PIN_SET	               ALT1250_GPIO52

/* Interface configuration */
#define PWM2_CLK_DIV_DEFAULT           (1)
#define PWM2_DUTY_CYCLE_DEFAULT        (512)

/* PWM-3 */
/*********/

/* Pins configuration */
#define PWM3_PIN_SET	               ALT1250_GPIO40

/* Interface configuration */
#define PWM3_CLK_DIV_DEFAULT           (1)
#define PWM3_DUTY_CYCLE_DEFAULT        (512)
