...
#include "hibernate.h"                  // Stateful hibernation support
#endif
/*---------------------------------------------------------------------------*/
...
#if (configUSE_ALT_SLEEP == 1)
  static UNCOMPRESSED StaticTask_t Idle_TCB;
  static UNCOMPRESSED StackType_t  Idle_Stack[configMINIMAL_STACK_SIZE];
#else
