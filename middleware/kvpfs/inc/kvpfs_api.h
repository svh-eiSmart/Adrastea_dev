 ...
 * Application calls this function prior to entering stateful PSM mode in order to reduce the amount
 * of flash writing count.
 * @return int32_t eturn 0 on success. Return negtive for errors. Refer to kvpfs_err.h for error
 * reasons.
 */
