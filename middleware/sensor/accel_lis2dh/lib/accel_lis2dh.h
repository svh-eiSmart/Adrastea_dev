...
#ifdef SENSOR_CFG_OVERLAY
#include "sensor_projcfg.h"
#endif
...
#define ACCEL_SENSOR_BUS             I2C_BUS_1                         /**< I2C bus ID */
#endif
...
typedef struct {
  ...
  GPIO_Id int_pin_set;       /**< MCU gpio to connect to the accelerometer INTx pin*/
} accel_ev_cfg_t;
 ...
 * This API will register i2c sensor device to sensor lib and do necessary configuration of
 ...
 * This API only clears gpio interrupt and the ix_iax bit of each interrupt source without clear the
...
/**
 * @brief Read the accelerometer raw data in mg for x, y, and z axis.
 *
...
/**
 * @brief Query if there is accelerometer raw data to read.
 *
...
/**
 * @brief Configure accelerometer power mode.
 *
...
/**
 * @brief Querry accelerometer ODR value.
 *
...
/**
 * @brief Configure accelerometer ODR value.
 *
...
/**
 * @brief Configure accelerometer FIFO.
 *
...
/**
 * @brief Configure accelerometer high pass filter enable status on output registers and FIFO
 *
...
/**
 * @brief Query accelerometer high pass filter enable status on output registers and FIFO
 *
 * @param [out] enable: Current enable status
 *
 * @return @ref accel_ret_e.
 */
