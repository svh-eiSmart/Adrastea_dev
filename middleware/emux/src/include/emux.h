 ...
 * @return See @ref _emux_transfer_result.
 */
static inline int32_t MUX_Receive(emux_handle_t handle, uint8_t *buffer, uint32_t length) {
  return MUX_ReceiveTimeout(handle, buffer, length, ALT_OSAL_TIMEO_FEVR);
}
