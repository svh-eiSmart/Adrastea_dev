...
#ifndef SLEEP_NOTIFY_H_
#define SLEEP_NOTIFY_H_
 ...
 * @note The user callback should defined as the below prototype:
 *       int32_t pm_notify_callback(pm_notify_state pm_state, void* ptr_ctx)
 * The user callback should defined as the below prototype:
 * int32_t pm_notify_callback(pm_notify_state pm_state, void* ptr_ctx)
 * Arguments:
 ...
 * @param [in] pwr_mode: Power mode being entered or left.
 *
