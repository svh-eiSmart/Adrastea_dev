...
#define APICMD_SET_REP_EVT_PDN_ACTEVT (1 << 12)
...
#define APICMD_REPORT_EVT_TYPE_PDN_ACTEVT (12)
...
#define APICMD_REP_CONPHASE_RAT_GSM (2)
...
#define APICMD_REP_CONPHASE_SCAN_REASON_REGULAR_SCAN (1)
#define APICMD_REP_CONPHASE_SCAN_REASON_RESELECT_SCAN (2)
#define APICMD_REP_CONPHASE_SCAN_REASON_OUT_OF_COVERAGE (3)
#define APICMD_REP_CONPHASE_SCAN_REASON_HIGH_PRIORITY (4)
#define APICMD_REP_CONPHASE_SCAN_REASON_LIMITED_SERVICE (5)
#define APICMD_REP_CONPHASE_SCAN_REASON_COPS (6)
#define APICMD_REP_CONPHASE_SCAN_REASON_OTHER (7)
...
begin_packed_struct struct apicmd_cmddat_pdnactevt_s {
  uint8_t cid;
  uint8_t event;
} end_packed_struct;
...
begin_packed_struct struct apicmd_cmddat_repevt_s {
  ...
  begin_packed_struct union {
    ...
    struct apicmd_cmddat_pdnactevt_s pdnactevt;
  } end_packed_struct u;
} end_packed_struct;
