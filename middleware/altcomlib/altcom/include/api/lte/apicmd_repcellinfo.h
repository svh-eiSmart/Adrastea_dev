...
begin_packed_struct struct apicmd_cmddat_cellinfo_2g_s {
  uint8_t valid;
  uint8_t mcc[APICMD_SET_REPCELLINFO_MCC_DIGIT];
  uint8_t mnc_digit;
  uint8_t mnc[APICMD_SET_REPCELLINFO_MNC_DIGIT_MAX];
...
begin_packed_struct struct apicmd_cmddat_repcellinfo_2g_s {
  struct apicmd_cmddat_cellinfo_2g_s serv_cell;
  uint8_t neighbor_num;
  struct apicmd_cmddat_cellinfo_2g_s neighbor_cell[APICMD_SET_REPCELLINFO_NEIGHBOR_CELL_NUM_MAX];
} end_packed_struct;
