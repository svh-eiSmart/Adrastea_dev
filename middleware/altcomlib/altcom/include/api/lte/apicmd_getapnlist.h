...
#define APICMD_GETAPNLIST_USERNAME_LEN (64)
#define APICMD_GETAPNLIST_PASS_LEN (32)

#define APICMD_GETAPNLIST_IPTYPE_IP (0)
#define APICMD_GETAPNLIST_IPTYPE_IPV6 (1)
#define APICMD_GETAPNLIST_IPTYPE_IPV4V6 (2)

#define APICMD_GETAPNLIST_RES_LIST_MAX_NUM (15)
...
begin_packed_struct struct apicmd_cmddat_getapndatav2_s {
  uint8_t session_id;
  uint8_t apn[APICMD_GETAPNLIST_APN_LEN];
  uint8_t ip_type;
  uint8_t auth_type;
  uint8_t username[APICMD_GETAPNLIST_USERNAME_LEN];
  uint8_t password[APICMD_GETAPNLIST_PASS_LEN];
  uint8_t hostname[APICMD_GETAPNLIST_APN_LEN];
  uint8_t ipv4addralloc;
  uint8_t pcscf_discovery;
  uint8_t nslpi;
} end_packed_struct;

begin_packed_struct struct apicmd_cmddat_getapnlistresv2_s {
  uint8_t result;
  uint8_t listnum;
  struct apicmd_cmddat_getapndatav2_s apnlist[APICMD_GETAPNLIST_RES_LIST_MAX_NUM];
} end_packed_struct;
