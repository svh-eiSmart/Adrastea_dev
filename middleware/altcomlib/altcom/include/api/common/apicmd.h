...
#define APICMD_VER APICMD_VER_V4
...
enum apiCmdId {
  ...
  APICMDID_GET_PDNINFO = 0x00A5,
  APICMDID_GET_APNLISTV2 = 0x00A6,
  APICMDID_SET_APNV2 = 0x00A7,
  APICMDID_SET_REP_CELLINFO_2G = 0x00A8,
  APICMDID_GET_CELLINFO_2G = 0x00A9,
  APICMDID_REPORT_CELLINFO_2G = 0x00AA,
  APICMDID_GET_PDPADDR = 0x00AB,
  APICMDID_SET_REP_QUALITY_2G = 0x00AC,
  APICMDID_GET_QUALITY_2G = 0x00AD,
  APICMDID_REPORT_QUALITY_2G = 0x00AE,
  ...
  APICMDID_GPS_IGNSSCEP = 0x0053,
  APICMDID_GPS_SETEV = 0x0054,
  APICMDID_GPS_MEMERASE = 0x0055,
  APICMDID_GPS_ROLLOVERCFG = 0x0056,
  APICMDID_GPS_INFO = 0x0057,
  APICMDID_GPS_BLANKINGCFG = 0x0058,
  APICMDID_GPS_TOWCFG = 0x0059,
  APICMDID_GPS_SATSCFG = 0x005A,
  ...
  APICMDID_SOCK_GETPEERNAME = 0x0093,
  APICMDID_SOCK_IOCTL = 0x0094,
  APICMDID_SOCK_GETADDRINFO_EXT = 0x0095,
...
#ifdef __ENABLE_MBEDTLS_API__
  /* MBEDTLS API commands */
  APICMDID_TLS_SSL_CMD = 0x0140,
  APICMDID_TLS_CONFIG_CMD = 0x0160,
  APICMDID_TLS_CONFIG_VERIFY_CALLBACK = 0x0161,
  APICMDID_TLS_SESSION_CMD = 0x0170,
  APICMDID_TLS_X509_CRT_CMD = 0x0180,
  APICMDID_TLS_X509_CRT_INFO = 0x0181,
  APICMDID_TLS_PK_CMD = 0x0190,
  APICMDID_TLS_CTR_DRBG_CMD = 0x01A0,
  APICMDID_TLS_ENTROPY_CMD = 0x01B0,
  APICMDID_TLS_CIPHER_CMD = 0x01C0,
#endif /* __ENABLE_MBEDTLS_API__ */

#ifdef __ENABLE_IO_API__
  /* I/O API commands */
  APICMDID_IO_OPEN = 0x0280,
  APICMDID_IO_CLOSE = 0x0281,
  APICMDID_IO_WRITE = 0x0282,
  APICMDID_IO_READ = 0x0283,
  APICMDID_IO_REMOVE = 0x0284,
  APICMDID_IO_LSEEK = 0x0285,
#endif /* __ENABLE_IO_API__ */

#ifdef __ENABLE_FS_API__
  /* File System API commands */
  APICMDID_FS_GETFILELIST = 0x0290,
  APICMDID_FS_OPENDIR = 0x0291,
  APICMDID_FS_READDIR = 0x0292,
  APICMDID_FS_CLOSEDIR = 0x0293,
  APICMDID_FS_MKDIR = 0x0294,
  APICMDID_FS_RMDIR = 0x0295,
  APICMDID_FS_STAT = 0x0296,
/* TODO: Add more here */
#endif /* __ENABLE_FS_API__ */

#ifdef __ENABLE_SMS_API__
  /* SMS API commands */
  APICMDID_SMS_INIT = 0x0330,
  APICMDID_SMS_FIN = 0x0331,
  APICMDID_SMS_SEND = 0x0332,
  APICMDID_SMS_REPORT_RECV = 0x0333,
  APICMDID_SMS_DELETE = 0x0334,
  APICMDID_SMS_GET_STGEINFO = 0x0335,
  APICMDID_SMS_GET_LIST = 0x0336,
  APICMDID_SMS_READ = 0x0337,
...
#ifdef __ENABLE_HTTP_API__
  /* HTTP API commands */
  APICMDID_HTTP_CMDCLEAR = 0x00360,
  APICMDID_HTTP_CMDABORT = 0x00361,
  APICMDID_HTTP_CMDCONFIGNODE = 0x00362,
  APICMDID_HTTP_CMDCONFIGIP = 0x00363,
  APICMDID_HTTP_CMDCONFIGTLS = 0x00364,
  APICMDID_HTTP_CMDCONFIGFORMAT = 0x00365,
  APICMDID_HTTP_CMDCONFIGTIMEOUT = 0x00366,
  APICMDID_HTTP_CMDCOMMANDS = 0x00367,
  APICMDID_HTTP_CMDURCS = 0x00368,
  APICMDID_HTTP_CMDREADDATA = 0x00369,
#endif /* __ENABLE_HTTP_API__ */
...
#ifdef __ENABLE_MBEDTLS_API__
  APIMODULEID_MBEDTLS = 0x09,
#endif /* __ENABLE_MBEDTLS_API__ */

/* CAUTION: PLEASE DO NOT USE 0x0A */
...
/* CAUTION: PLEASE DO NOT USE 0x0D */

#ifdef __ENABLE_SMS_API__
  APIMODULEID_SMS = 0x0E,
#endif /* __ENABLE_SMS_API__ */
#ifdef __ENABLE_ATSOCKET_API__
  APIMODULEID_ATSOCKET = 0x0F,
#endif /* __ENABLE_ATSOCKET_API__ */
#ifdef __ENABLE_COAP_API__
  APIMODULEID_COAP = 0x10,
#endif /* __ENABLE_COAP_API__ */
#ifdef __ENABLE_HTTP_API__
  APIMODULEID_HTTP = 0x11,
#endif /* __ENABLE_HTTP_API__ */
};

#ifdef __ENABLE_LTE_API__
#define LTEVER_MAJOR 0
#define LTEVER_MINOR 15
#endif /* __ENABLE_LTE_API__ */
#ifdef __ENABLE_SOCKET_API__
#define SOCKETVER_MAJOR 0
#define SOCKETVER_MINOR 4
#endif /* __ENABLE_SOCKET_API__ */
#ifdef __ENABLE_ATCMD_API__
...
#define COAPVER_MINOR 2
#endif
#ifdef __ENABLE_HTTP_API__
#define HTTPVER_MAJOR 0
#define HTTPVER_MINOR 3
#endif
#ifdef __ENABLE_GPS_API__
#define GPSVER_MAJOR 0
#define GPSVER_MINOR 4
#endif /* __ENABLE_GPS_API__ */
#ifdef __ENABLE_CERTMGMT_API__
...
#define LWM2MVER_MINOR 6
#endif /* __ENABLE_LWM2M_API__ */
#ifdef __ENABLE_MBEDTLS_API__
#define MBEDTLSVER_MAJOR 0
#define MBEDTLSVER_MINOR 3
#endif /* __ENABLE_MBEDTLS_API__ */
#ifdef __ENABLE_MISC_API__
...
#endif /* __ENABLE_MISC_API__ */
#ifdef __ENABLE_IO_API__
#define IOVER_MAJOR 0
#define IOVER_MINOR 1
#endif /* __ENABLE_IO_API__ */
#ifdef __ENABLE_FS_API__
#define FSVER_MAJOR 0
#define FSVER_MINOR 2
#endif /* __ENABLE_FS_API__ */
#ifdef __ENABLE_SMS_API__
#define SMSVER_MAJOR 0
#define SMSVER_MINOR 1
#endif /* __ENABLE_SMS_API__ */
/****************************************************************************
 * Public Types
 ****************************************************************************/
