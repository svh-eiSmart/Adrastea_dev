...
#ifndef ALTCOM_INCLUDE_API_HTTP_APICMDHDLR_URCEVT_H_
#define ALTCOM_INCLUDE_API_HTTP_APICMDHDLR_URCEVT_H_
...
#endif /* ALTCOM_INCLUDE_API_HTTP_APICMDHDLR_URCEVT_H_ */
