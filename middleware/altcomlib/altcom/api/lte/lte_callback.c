...
quality_2g_report_cb_t g_quality_2g_callback = NULL;
cellinfo_report_cb_t g_cellinfo_callback = NULL;
cellinfo_2g_report_cb_t g_cellinfo_2g_callback = NULL;
...
pdn_actevt_report_cb_t g_pdn_actevt_report_callback = NULL;
...
void *g_quality_2g_cbpriv = NULL;
void *g_cellinfo_cbpriv = NULL;
void *g_cellinfo_2g_cbpriv = NULL;
...
void *g_pdn_actevt_report_cbpriv = NULL;
...
void lte_callback_init(void) {
  ...
  g_quality_2g_callback = NULL;
  g_cellinfo_callback = NULL;
  g_cellinfo_2g_callback = NULL;
  ...
  g_fw_upgrade_evt_report_callback = NULL;
  g_pdn_actevt_report_callback = NULL;
  ...
  g_quality_2g_cbpriv = NULL;
  g_cellinfo_cbpriv = NULL;
  g_cellinfo_2g_cbpriv = NULL;
  ...
  g_fw_upgrade_evt_report_cbpriv = NULL;
  g_pdn_actevt_report_cbpriv = NULL;
}
