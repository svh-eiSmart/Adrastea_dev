...
static bool g_lte_setpdnactevt_isproc = false;
...
int32_t lte_set_report_pdn_activation(pdn_actevt_report_cb_t pdn_evt_callback, void *userPriv) {
  return lte_set_report_event(APICMD_SET_REP_EVT_PDN_ACTEVT, (void *)&g_lte_setpdnactevt_isproc,
                              (void **)&g_pdn_actevt_report_callback,
                              (void **)&g_pdn_actevt_report_cbpriv, (void *)pdn_evt_callback,
                              (void *)userPriv);
}
