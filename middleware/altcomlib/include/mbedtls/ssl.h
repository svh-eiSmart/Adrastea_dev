...
/**
 * \brief               Omit the use of hostname in certain places during
 *                      handshake, such as CN verification or SNI extension.
 *
 * \param conf          SSL configuration
 * \param omission      omission setting (MBEDTLS_SSL_HOSTNAME_OMISSION_NAME_CHECK and MBEDTLS_SSL_HOSTNAME_OMISSION_SNI)
 *
 */
#define MBEDTLS_SSL_HOSTNAME_OMISSION_DEFAULT 0
#define MBEDTLS_SSL_HOSTNAME_OMISSION_NAME_CHECK 1
#define MBEDTLS_SSL_HOSTNAME_OMISSION_SNI 2
