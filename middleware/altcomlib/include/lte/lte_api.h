...
#define LTE_APN_USER_NAME_LEN (64) /**< The maximum string length of the APN user name */
...
#define LTE_APN_PASSWD_LEN (32) /**< The maximum string length of the APN password */
...
#define LTE_CCID_LEN (21) /**< The maximum string length of the APN password */
...
#define LTE_TIMING_ADV_NA (65535) /**< Invalid timing advance value */
...
#define LTE_VER_BB_PRODUCT_LEN (5)  /**< Length of character string for BB product */
#define LTE_VER_NP_PACKAGE_LEN (32) /**< Length of character string for NP package */
...
/**
 * @defgroup lteipstrlen Maximum length of IPv4/v6 string
 * @{
 */

/**
 * @brief
 * Definitions of maximum length of IPv4/v6 string.
 */

#define LTE_IP_STRLEN (64) /**< Maximum length of IP string in dotted(v4)/colon(v6) notation */
...
/**
 * @brief
 * Enumeration of RAT switch request arbitrator
 */
typedef enum {
...
/**
 * @brief
 * Enumeration of RAT setting persistency
 */
typedef enum {
...
/**
 * @brief
 * Enumeration of the FW upgrade confirmation
 */
...
/**
 * @brief
 * Enumeration of the FW upgrade result
 */
...
/**
 * @brief
 * Enumeration of the FW upgrade state
 */
typedef enum {
...
/**
 * @defgroup ltepsmfunctionality_e PSM functionality
 * @{
 */

/**
 * @brief
 * Enumerations of PSM functionality flag
 */
typedef enum {
  LTE_PSM_DISABLE = 0,          /**< Disable PSM*/
  LTE_PSM_ENABLE_FORCE_OFF = 1, /**< Enable PSM by NW*/
  LTE_PSM_ENABLE_FORCE_ON = 2   /**< Enable PSM and force enter*/
} ltepsmfunctionality_e;
...
/**
 * @brief
 * Enumeration of IPv4 address allocation.
 */

typedef enum {
  ALLOC_NASSIG, /**< IPv4 address allocation through NAS signalling */
  ALLOC_DHCP,   /**< IPv4 address allocation through DHCP */
  ALLOC_MAX     /**< Maximum guard */
} lte_ipv4addralloc_t;

/**
 * @brief
 * Enumeration of indication of NSLPI.
 */
typedef enum {
  NSLPI_CONFIGURED, /**< indicates that this PDP context is to be activated with the value for the
low priority indicator configured in the MT */
  NSLPI_NOTCONFIGURED, /**< indicates that this PDP context is is to be activated with the value for
the low priority indicator set to "MS is not configured for NAS signalling low priority" */
  NSLPI_MAX            /**< Maximum guard */
} lte_nslpi_t;

/**
 * @brief
 * Definition of APN settings data V2.
 */

typedef struct {
  uint8_t session_id;                   /**< Numeric value of the session ID */
  char apn[LTE_APN_LEN];                /**< Access Point Name, NULL terminated */
  lteapniptype_e ip_type;               /**< Internet Protocol type. See @ref lteapniptype */
  lteapnauthtype_e auth_type;           /**< PPP authentication type. See @ref lteapnauthtype */
  char username[LTE_APN_USER_NAME_LEN]; /**< Username for authentication, NULL terminated */
  char password[LTE_APN_PASSWD_LEN];    /**< Password for authentication, NULL terminated */
  char hostname[LTE_APN_LEN];           /**< Name of authentication server, NULL terminated */
  lte_ipv4addralloc_t ipv4addralloc;    /**< IPv4 address allocation through NAS signalling/DHCP */
  lteenableflag_e pcscf_discovery;      /**< Enable/Disable P-CSCF discovery */
  lte_nslpi_t nslpi; /**< Indicates the NAS signalling priority requested for this PDP context */
} lte_apndatav2_t;

/**
 * @brief
 * Definition of APN settings list V2.
 */

typedef struct {
  uint8_t listnum;                             /**< Number of APN data list. */
  lte_apndatav2_t apnlist[LTE_SESSION_ID_MAX]; /**< List of APN data. See @ref lte_apndatav2_t */
} lte_apnlistv2_t;
...
typedef struct {
  lte_timerevt_evttype_t ev_type; /**< Timer event type */
  lte_timerevt_mode_t mode;       /**< Timer operation mode */
  lte_timerevt_evsel_t ev_sel;    /**< Timer event selector */
  uint32_t preceding_time;        /**< Preceding time of timer event */
} lte_settimerevt_t;
...
typedef struct {
  fw_upgrade_cmd_t cmd;                  /**< Firmware upgrade command */
  fw_upgrade_cmd_confirm_t confirmation; /**< Command confirmation */
  fw_upgrade_result_t result;            /**< Result of command */
...
typedef struct {
  fw_upgrade_state_t state;        /**< Firmware upgrade state */
  ...
  fw_upgrade_result_t fota_result; /**< Result of FOTA */
...
/**
 * @brief
 * Definition of parameters for signal quality information.
...
/**
 * @brief
 * Definition of parameters for 2G signal quality information.
 * This is reported by quality_report_cb_t
 */

typedef struct lte_quality_2g {
  ltevalidflag_t
      valid;    /**< Refer to the following parameters only when this flag is valid. This is because
                   valid parameters can not be acquired when RF function is OFF and so on */
  uint8_t rssi; /**< RSSI indicator, from 0 (-113 dBm and lower) to 31 (-51 dBm and higher), 99
                   means not detectable */
  uint8_t ber;  /**< Bit error rate from 0 to 7, 99 means not detectable */
} lte_quality_2g_t;
...
/**
 * @brief
 * Definition of structure for 2G cell information.
 */

typedef struct {
  ltevalidflag_t valid;                    /**< Refer to the following parameters only when this
                                      flag is valid, plase refer to @ref ltevalidflag_t */
  uint8_t mcc[LTE_CELLINFO_MCC_DIGIT];     /**< Mobile Country Code (000-999)
                                                See @ref lteidentifier */
  uint8_t mnc_digit;                       /**< Digit number of mnc(2-3) */
  ...
  uint32_t bs_id;                          /**< Base station ID */
  uint32_t arfcn;                          /**< ARFCN */
  uint32_t rx_level;                       /**< Recieved signal strength level */
  uint8_t t_adv;                           /**< Timing advance */
} lte_cell_2g_t;

/**
 * @brief
 * Definition of structure for aggregated 2G cell information.
 * This is reported by cellinfo_2g_report_cb_t
 */

typedef struct {
  lte_cell_2g_t serv_cell; /**< Serving cell information, see @ref lte_cell_2g_t*/
  uint8_t neighbor_num;    /**< Valid number of neighbor information */
  lte_cell_2g_t neighbor_cell[LTE_MAX_NEIGHBOR_CELL_INFO]; /**< Neighbor cell information, see @ref
                                                              lte_cell_2g_t */
} lte_cellinfo_2g_t;
...
typedef struct lte_psm_setting {
  ltepsmfunctionality_e func;              /**< PSM enable. See @ref ltepsmfunctionality_e */
...
typedef enum {
  ...
  LTE_CONPHASE_SCAN_REASON_REGULAR_SCAN = 1,    /**< Regular scan */
  LTE_CONPHASE_SCAN_REASON_RESELECT_SCAN = 2,   /**< Reselection triggered scan */
  LTE_CONPHASE_SCAN_REASON_OUT_OF_COVERAGE = 3, /**< Out of coverage triggered scan*/
  LTE_CONPHASE_SCAN_REASON_HIGH_PRIORITY = 4,   /**< High priority plmn search */
  LTE_CONPHASE_SCAN_REASON_LIMITED_SERVICE = 5, /**< Limited service scan*/
  LTE_CONPHASE_SCAN_REASON_COPS = 6,            /**< Host query (COPS) */
  LTE_CONPHASE_SCAN_REASON_OTHER = 7,           /**< Other */
...
typedef struct {
  ...
  uint8_t package_name[LTE_LWM2M_FW_UPGRADE_PACKAGE_NAME_LEN]; /**< Package name.*/
...
/**
 * @brief
 * Definition of PDN information structure.
 */

typedef struct {
  struct {
    bool is_valid;                   /**< Entry valid indicator */
    lteapniptype_e ip_type;          /**< IP type of active PDN information */
    uint32_t cid;                    /**< cid of activate PDN */
    uint32_t bearer_id;              /**< bearer of activate PDN */
    char apn_name[LTE_APN_LEN];      /**< APN name of activate PDN */
    char ip_str[LTE_IP_STRLEN];      /**< IP string in dotted(v4)/colon(v6) notation */
    char nmask_str[LTE_IP_STRLEN];   /**< Netmask string in dotted(v4)/colon(v6) notation */
    char gw_str[LTE_IP_STRLEN];      /**< Gateway string in dotted(v4)/colon(v6) notation */
    char pri_dns_str[LTE_IP_STRLEN]; /**< Primary DNS string in dotted(v4)/colon(v6) notation */
    char sec_dns_str[LTE_IP_STRLEN]; /**< Secondary DNS string in dotted(v4)/colon(v6) notation */
  } pdn[2];                          /**< Active PDN information, includes IPv4/v6 */
} lte_pdn_info_t;

/**
 * @brief
 * Definition of PDP addresss structure.
 */

typedef struct {
  uint32_t cid; /**< cid of PDP context */
  struct {
    bool is_valid;              /**< Entry valid indicator */
    lteapniptype_e ip_type;     /**< IP type of the PDP address */
    char ip_str[LTE_IP_STRLEN]; /**< IP string in dotted(v4)/colon(v6) notation */
  } addr[2];                    /**< PDP address of specified context, includes IPv4/v6 */
} lte_pdp_addr_t;

/**
 * @brief
 * Enumeration of PDN activation event.
 */

typedef enum {
  PDN_EVT_ME_DEACT = 0, /**< PDN deactivated from mobile terminal */
  PDN_EVT_ME_ACT,       /**< PDN activated from mobile terminal */
  PDN_EVT_NW_DEACT,     /**< PDN deactivated from network */
  PDN_EVT_NW_ACT        /**< PDN activated from network */
} lte_pdn_event_t;
 ...
 * @brief
 *
 * @param [in] cid: The ID of the PDP context.
 * @param [in] event: event of the context, please also see @ref lte_pdn_event_t.
 * @param [in] userPriv: User's private data.
 *
 */

typedef void (*pdn_actevt_report_cb_t)(uint8_t cid, lte_pdn_event_t event, void *userPriv);

/**
 * @brief
 *  The 2G cell information is reported by this function. It is reported
 *  at intervals of the set report period.
 * @param [in] cellinfo: 2G Cell information. See @ref lte_cellinfo_2g_t.
 * @param [in] userPriv: User's private data.
 */

typedef void (*cellinfo_2g_report_cb_t)(lte_cellinfo_2g_t *cellinfo, void *userPriv);

/**
 * @brief
 *  The quality information is reported by this function. It is reported
 *  at intervals of the set report period.
 * @param [in] quality: 2G Quality information.
 * See @ref lte_quality_t.
 * @param [in] userPriv: User's private data.
 */

typedef void (*quality_2g_report_cb_t)(lte_quality_2g_t *quality, void *userPriv);
 ...
 * The event registration behavior of this API effected by @ref altcom_init_t.cbreg_only.
 *
...
/**
 * @brief lte_get_apnlistv2() get current APN configuration list.
 *
 * @param [inout] apn: APN settings, and it's valid only if LTE_RESULT_OK returned;
 *
 * @return On success, LTE_RESULT_OK is returned. On failure,
...
lteresult_e lte_get_apnlistv2(lte_apnlistv2_t *apn);
...
/**
 * @brief lte_set_apnv2() set access point name settings.
 *
 * @param [in] session_id: The numeric value of the session ID.
 * See @ref ltesessionid for valid range
 * @param [in] apn: Character string of Access Point Name. The maximum string length is
 ...
 * @param [in] password: Character string of password.
 * The maximum string length is LTE_APN_PASSWD_LEN, end with '\0'.
 * @param [in] hostname: Character string of hostname.
 * The maximum string length is LTE_APN_LEN, end with '\0'.
 * @param [in] pcscf_discovery: Enable/Disable P-CSCF discovery
 * @param [in] ipv4addralloc: IPv4 address allocation through NAS signalling/DHCP
 * @param [in] nslpi: Indicates the NAS signalling priority requested for this PDP context
 *
 * @return On success, LTE_RESULT_OK is returned. On failure,
 * LTE_RESULT_ERR is returned.
 */
...
/**
 * @brief lte_set_report_pdn_activation() Change the report setting of the PDN activation event.
 * The default report setting is disable.
 * The event registration behavior of this API effected by @ref altcom_init_t.cbreg_only.
 *
 * @param [in] pdn_evt_callback: Callback function to notify that
 * PDN activation event. please also see @ref pdn_actevt_report_cb_t.
...
int32_t lte_set_report_pdn_activation(pdn_actevt_report_cb_t pdn_evt_callback, void *userPriv);

/**
 * @brief lte_set_report_cellinfo_2g() Change the report setting of the 2G cell
 * information. The default report setting is disable.
 * The event registration behavior of this API effected by @ref altcom_init_t.cbreg_only.
 *
 * @param [in] cellinfo_callback: Callback function to notify the 2G cell information.
 *  If NULL is set, the report setting is disabled.
 * @param [in] period: Reporting cycle in sec (1-4233600)
 * @param [in] userPriv: User's private data
 *
...
/**
 * @brief lte_get_cellinfo_2g() get the current 2G cell information.
 *
 * @param [inout] cellinfo: 2G Cell information. See @ref lte_cellinfo_2g_t
 *
 * @return On success, LTE_RESULT_OK is returned. On failure,
 * LTE_RESULT_ERR is returned.
 */
...
/**
 * @brief Get address of from a PDP context
 *
...
/**
 * @brief lte_set_report_quality_2g() Change the report setting of the 2G signal quality
 * information. The default report setting is disable.
 * The event registration behavior of this API effected by @ref altcom_init_t.cbreg_only.
 *
 * @param [in] quality_callback: Callback function to notify that
...
int32_t lte_set_report_quality_2g(quality_2g_report_cb_t quality_callback, uint32_t period,
                                  void *userPriv);

/**
 * @brief lte_get_quality_2g() get the current 2G cell quality information.
 *
 * @param [in] quality: Quality information.
 * See @ref lte_quality_t
 *
...
lteresult_e lte_get_quality_2g(lte_quality_2g_t *quality);
